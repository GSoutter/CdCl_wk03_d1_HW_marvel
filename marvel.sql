...
-- The cinema has just heard that they will be holding an exclusive midnight showing of
...
-- there are several methods to delete mutiple entries from your table in a single command. couple given as examples below.
